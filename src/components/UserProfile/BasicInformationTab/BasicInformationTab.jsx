    ...
    <div>
      <div data-testid="basic-info-tab" className="basic-info-tab-desktop">
        ...
        <Row style={{ marginBottom: '10px' }}>
          ...
          <Col md="6">
            <Label>
              if(userProfile.isActive) Active else if( userProfile.reactivationDate)
          ...
          <Col style={{ alignItems: 'center', justifyContent: 'center' }}>
            ...
            <div>
              <Label style={{ fontWeight: 'normal' }}>
                if(userProfile.isActive) `Active` else if ( userProfile.reactivationDate) `Paused
                until ${formatDate(userProfile.reactivationDate)}` else `Inactive`
              </Label>
              &nbsp;
