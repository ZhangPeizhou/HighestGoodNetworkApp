...
export function Timer(props) {
  ...
  return (
    <div className={css.timerContainer}>
      <button disabled={isButtonDisabled} type="button" onClick={toggleTimer}>
        <BsAlarmFill
      ...
      <div className={css.btns}>
        ...
        {!started || paused ? (
          <button disabled={isButtonDisabled} type="button" onClick={handleStartButton}>
            <FaPlayCircle
              className={cs(
                isButtonDisabled ? css.btnDisabled : css.transitionColor,
          ...
          <button disabled={isButtonDisabled} type="button" onClick={sendPause}>
            <FaPauseCircle
